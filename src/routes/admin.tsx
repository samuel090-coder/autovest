...
import { LayoutDashboard, Boxes, Sparkles, Image as ImageIcon, Users, Receipt, ArrowLeft, Settings, LifeBuoy, Bell } from "lucide-react";
...
function AdminLayout() {
  ...
  const items: Array<{ to: "/admin" | "/admin/investments" | "/admin/ai-create" | "/admin/banners" | "/admin/users" | "/admin/transactions" | "/admin/complaints" | "/admin/settings" | "/admin/notifications"; label: string; icon: typeof LayoutDashboard; exact?: boolean }> = [
