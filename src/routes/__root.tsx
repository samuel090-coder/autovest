...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "InvestWise Dashboard is a comprehensive investment management platform for users and administrators." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "InvestWise Dashboard is a comprehensive investment management platform for users and administrators." },
